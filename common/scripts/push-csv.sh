...
set -e
QUAY_NAMESPACE=${QUAY_NAMESPACE:-danielxlee}
QUAY_REPOSITORY=${QUAY_REPOSITORY:-memcached-operator-app}
BUNDLE_DIR=${BUNDLE_DIR:-deploy/olm-catalog/memcached-operator}
